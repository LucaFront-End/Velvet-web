...
const WA_MESSAGE = 'Hola, me interesa cotizar un servicio de tapicería'
...
export default function WhatsAppButton() {
    ...
    useEffect(() => {
        // Show after a short delay so it doesn't pop on first paint
        const show = setTimeout(() => setVisible(true), 1800)
        // Pulse attention every 8s
    ...
    return (
        ...
        >
            ...
            <svg className="wa-fab-icon" viewBox="0 0 24 24" fill="currentColor">
            ...
            <span className="wa-fab-tooltip">¿Necesitás ayuda?</span>
        </a>
    )
}
