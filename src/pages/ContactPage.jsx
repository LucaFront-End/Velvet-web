...
export default function ContactPage() {
    ...
    const handleSubmit = (e) => {
        ...
        const subject = `Cotización - ${form.service || 'Tapicería'}`
        const body = `Hola Velvet Tapicería 👋\n\n` +
            `Nombre: ${form.name}\n` +
            `Teléfono: ${form.phone}\n` +
            `Correo: ${form.email}\n` +
            `Servicio: ${form.service}\n` +
            `Mensaje: ${form.message}`
        window.location.href = `mailto:hola@tapiceriavelvet.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`
        setSubmitted(true)
        ...
        <div className="contact-page" ref={pageRef}>
            ...
            <section className="cp-map cp-reveal">
                ...
                <div className="cp-map-embed">
                    <iframe
                        title="Ubicación Velvet Tapicería — Naucalpan"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3762.5!2d-99.2396!3d19.4738!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85d203b3b738c36f%3A0x1!2sCto.%20Empresarial%2013%2C%20San%20Fernando%2C%2052765%20Naucalpan%20de%20Ju%C3%A1rez%2C%20M%C3%A9x.!5e0!3m2!1ses!2smx!4v1700000000000"
                        width="100%"
                        height="400"
                        style={{ border: 0 }}
                        allowFullScreen=""
